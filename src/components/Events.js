  ...
  <div className="events__body">
    <div className="events__body__content">
      ...
      <p className="about__subtitle">
        E Cell organises a plethora of events round the clock to promote
        entrepreneurial activities in and around the campus, and infuse its
        spirit among students.
      </p>
      <span className="button button--about">
          <Link to="/aboutPage">Events</Link>
        </span>
    </div>

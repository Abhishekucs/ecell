...
const StudentStartups = () => (
    <div className="studentStartups__body">
        <div className="studentStartups__body__content">
            ...
            <p className="about__subtitle">Under our aegis, students  project their creative ideas and get a lucrative opportunity of gaining first hand experience by incubating their own start-ups.</p>
            <Link to="/SsPage" className="button button--about">Student Startups</Link>
        </div>
